...
namespace RorzeUnit.Net.Sockets
{
    ...
    {
        Socket clientSocket;
        public event ClintChangEventHandler OnConnectChange;
        ...
        public delegate void ClintChangEventHandler(object sender, ClintChangEventArgs e);
        public class ClintChangEventArgs : EventArgs
        {
            public bool _connected;
            public ClintChangEventArgs(bool connected)
            {
        ...
        public bool ConnectStat
        {
            ...
            set { _bisConnect = value; if (OnConnectChange != null) OnConnectChange(this, new ClintChangEventArgs(_bisConnect)); }
        }
    }
}
